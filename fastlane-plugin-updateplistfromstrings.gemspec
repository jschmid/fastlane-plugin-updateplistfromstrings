...
require 'fastlane/plugin/updateplistfromstrings/version'

Gem::Specification.new do |spec|
  spec.name          = 'fastlane-plugin-updateplistfromstrings'
  spec.version       = Fastlane::Updateplistfromstrings::VERSION
  spec.author        = 'Jonas Schmid'
  ...
  spec.add_dependency 'fastlane-plugin-poeditor_export'
end
